    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/clients/**").hasAnyRole("ADMIN", "MANAGER", "CLIENT")
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/slas/**").hasAnyRole("ADMIN", "MANAGER")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/reports/*/export/**").hasAnyRole("ADMIN", "MANAGER", "CLIENT")
                        .requestMatchers(HttpMethod.POST, "/api/incidents/**").hasAnyRole("ADMIN", "MANAGER", "EMPLOYEE")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/slas/**", "/api/reports/**", "/api/projects/**", "/api/teams/**").hasAnyRole("ADMIN", "CLIENT", "MANAGER", "EMPLOYEE")
