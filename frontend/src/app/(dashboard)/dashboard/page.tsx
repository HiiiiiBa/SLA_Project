...
import type { Alert, Client, Report, Sla } from "@/types";
...
export default function DashboardPage() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const labels = ["SLA", "alertes", "rapports", "clients"];
        ...
        <>
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            ...
            <StatCard
              ...
              hint={`${clients.length} clients suivis`}
              ...
              <table className="min-w-full text-sm">
                ...
                <tbody>
                  {slas.slice(0, 8).map((sla) => (
                    <tr key={sla.id} className="border-t border-slate-100">
                      ...
                      <td className="px-6 py-4 text-slate-600">{sla.uptimeTarget}%</td>
